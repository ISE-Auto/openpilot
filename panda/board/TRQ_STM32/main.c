...
void pedal(void) {
  ...
  if (state == NO_FAULT) {
    //&& (!override)) {
    //this is where we can accept a CAN input

    // switch(direction){
    //   //this is just here to make me feel nice. forcing the Eon to send more valid commands
    //   case 0:
    //     // no direction
    //     dac_set(0, trq0);
    //     dac_set(1, trq1);
    ...
    //     break;
    //   default:
    //     //invalid direction probably should set some kind of fault, 2 sec locout or something.
    //     dac_set(0, trq0);
    //     dac_set(1, trq1);  
    //     break;
    // }
